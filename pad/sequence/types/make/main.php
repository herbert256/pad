<?php
  ...
  $GLOBALS ["pad_seq_$pad_seq_seq"] = [];

  foreach ( $pad_parms_tag as $pad_seq_opt_name => $pad_seq_opt_value )

    if ( $pad_seq_opt_name <> 'make' and pad_file_exists ( PAD . "sequence/types/$pad_seq_opt_name/make.php" ) ) {

      $GLOBALS ["pad_seq_$pad_seq_seq"] [] = $pad_seq_opt_name;
