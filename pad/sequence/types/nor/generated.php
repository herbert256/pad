<?php
  ...
  // Precomputed term cache for the nor sequence.
  //
  // const PADnor is empty (the sequence has no terms in the generated range).
  //
  // Loaded by sequence/build/include.php whenever this sequence is built, then read
  // by sequence/plays/play/order.php (term at index, PADnor[$pqLoop-1]) and by
