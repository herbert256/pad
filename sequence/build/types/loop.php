<?php
  ...
  elseif ( $pad_seq_from or $pad_seq_to <> PHP_INT_MAX ) {
    $pad_seq_loop_start = $pad_seq_from;
    $pad_seq_loop_end   = $pad_seq_to;
  }
  ...
  if ( $pad_seq_loop )
    $pad_seq_loop_type = $pad_seq_loop;
  ...
  for ( $pad_seq_loop_idx = $pad_seq_loop_start; $pad_seq_loop_idx <= $pad_seq_loop_end; $pad_seq_loop_idx++ ) {
    ...
    $pad_seq_loop_call = include PAD_HOME . "sequence/types/$pad_tag/$pad_seq_loop_type.php";    
