...
| `z99` | was `php_and_html/z99`, a stub outside the z01..z42 sequence that page walks. It is the one of the seven that uses nothing from `_common`, so it stayed in `regression/pages/manual/` when the rest moved here |
