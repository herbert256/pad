<?php
  ...
  $pad_seq_init = pad_seq_check ( $pad_seq_init, $pad_seq_increment, $pad_seq_even, $pad_seq_odd );
  $pad_seq_exit = pad_seq_check ( $pad_seq_exit, $pad_seq_increment, $pad_seq_even, $pad_seq_odd );
