# Regression: the memcached page cache

## Introduction

Regression test for the 'memcached' server-side page cache. The application caches its pages for
...
| `_config/config.php` | Switches the memcached cache on, 60 seconds, `_common` off |
