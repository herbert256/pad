/*
  PAD Demo Database: classicmodels
  From http://www.mysqltutorial.org
  Little tuning for Mariadb 10.5
*/

SET NAMES utf8;

/* Drop existing objecst if exists */

DROP DATABASE IF EXISTS `classicmodels`;
DROP USER     IF EXISTS 'classicmodels'@'localhost';

/* Create the database */

CREATE DATABASE `classicmodels` CHARACTER SET latin1 COLLATE latin1_bin;
...
(1002,'Murphy','Diane','x5800','dmurphyclassicmodelcars.com','1',NULL,'President'),
(1056,'Patterson','Mary','x4611','mpattersoclassicmodelcars.com','1',1002,'VP Sales'),
(1076,'Firrelli','Jeff','x9273','jfirrelliclassicmodelcars.com','1',1002,'VP Marketing'),
(1088,'Patterson','William','x4871','wpattersonclassicmodelcars.com','6',1056,'Sales Manager (APAC)'),
(1102,'Bondur','Gerard','x5408','gbondurclassicmodelcars.com','4',1056,'Sale Manager (EMEA)'),
(1143,'Bow','Anthony','x5428','abowclassicmodelcars.com','1',1056,'Sales Manager (NA)'),
(1165,'Jennings','Leslie','x3291','ljenningsclassicmodelcars.com','1',1143,'Sales Rep'),
(1166,'Thompson','Leslie','x4065','lthompsonclassicmodelcars.com','1',1143,'Sales Rep'),
(1188,'Firrelli','Julie','x2173','jfirrelliclassicmodelcars.com','2',1143,'Sales Rep'),
(1216,'Patterson','Steve','x4334','spattersonclassicmodelcars.com','2',1143,'Sales Rep'),
(1286,'Tseng','Foon Yue','x2248','ftsengclassicmodelcars.com','3',1143,'Sales Rep'),
(1323,'Vanauf','George','x4102','gvanaufclassicmodelcars.com','3',1143,'Sales Rep'),
(1337,'Bondur','Loui','x6493','lbondurclassicmodelcars.com','4',1102,'Sales Rep'),
(1370,'Hernandez','Gerard','x2028','ghernandeclassicmodelcars.com','4',1102,'Sales Rep'),
(1401,'Castillo','Pamela','x2759','pcastilloclassicmodelcars.com','4',1102,'Sales Rep'),
(1501,'Bott','Larry','x2311','lbottclassicmodelcars.com','7',1102,'Sales Rep'),
(1504,'Jones','Barry','x102','bjonesclassicmodelcars.com','7',1102,'Sales Rep'),
(1611,'Fixter','Andy','x101','afixterclassicmodelcars.com','6',1088,'Sales Rep'),
(1612,'Marsh','Peter','x102','pmarshclassicmodelcars.com','6',1088,'Sales Rep'),
(1619,'King','Tom','x103','tkingclassicmodelcars.com','6',1088,'Sales Rep'),
(1621,'Nishi','Mami','x101','mnishiclassicmodelcars.com','5',1056,'Sales Rep'),
(1625,'Kato','Yoshimi','x102','ykatoclassicmodelcars.com','5',1621,'Sales Rep'),
(1702,'Gerard','Martin','x2312','mgerardclassicmodelcars.com','4',1102,'Sales Rep');
...
insert  into `productlines`(`productLine`,`textDescription`,`padDescription`,`image`) values
