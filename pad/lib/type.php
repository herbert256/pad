<?php
  ...
  function padTypeGet ( $item ) {
    ...
    elseif ( file_exists        ( pad . "_tags/$item.php"              ) ) return 'pad';
    elseif ( file_exists        ( pad . "_tags/$item.pad"              ) ) return 'pad';
    ...
    elseif ( file_exists        ( pad . "_functions/$item.php"         ) ) return 'function';
  ...
  function padTypeCheck ( $type, $item ) {
    ...
    elseif ( $type == 'pad'      and file_exists        ( pad . "_tags/$item.php"              ) ) return $type;
    elseif ( $type == 'pad'      and file_exists        ( pad . "_tags/$item.pad"              ) ) return $type;
    ...
    elseif ( $type == 'function' and file_exists        ( pad . "_functions/$item.php"         ) ) return $type;
