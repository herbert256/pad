<?php
 ...
 if ( file_exists ( PAD . "pad/sequence/types/$padSeqSeq/one.php" ) ) 
  
    $padSequence = include PAD . "pad/sequence/types/$padSeqSeq/one.php";
  ...
  elseif ( $padSeqRandom and file_exists ( PAD . "pad/sequence/types/$padSeqSeq/random.php") )

    $padSequence = include PAD . "pad/sequence/types/$padSeqSeq/random.php" ;

  else

    $padSequence = include PAD . "pad/sequence/types/$padSeqSeq/$padSeqBuild.php";
