# Regression: the db page cache

## Introduction

Regression test for the 'db' server-side page cache. The application caches its pages for
...
| `_config/config.php` | Switches the db cache on, 60 seconds, `_common` off |
