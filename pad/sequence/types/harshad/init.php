<?php
  ...
  // Range setup for harshad, run before generation: the sequence is positive, so a run
  // told to start lower - {harshad from=0}, or a negative from - begins at the first
