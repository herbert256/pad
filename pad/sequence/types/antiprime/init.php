<?php
  ...
  // Range setup for antiprime, run before generation: the sequence is positive, so a run
  // told to start lower - {antiprime from=0}, or a negative from - begins at the first
