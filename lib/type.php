...
#    elseif ( padTagCheck      ( $type,                                 ) ) return 'tag';
  ...
  function padTypeCheck ( $type, $item ) {
    ...
    elseif ( $type == 'pad'      and file_exists      ( PAD . "tags/$item.php"             ) ) return TRUE;
    elseif ( $type == 'pad'      and file_exists      ( PAD . "tags/$item.html"            ) ) return TRUE;
    elseif ( $type == 'fragment' and padIsContentFile ( APP . "content/$item"                  ) ) return TRUE;
    elseif ( $type == 'tag'      and file_exists      ( PAD . "tag/$type.php"              ) ) return TRUE;
    ...
    elseif ( $type == 'sequence' and file_exists      ( PAD . "sequence/types/$item"       ) ) return TRUE;
    elseif ( $type == 'action'   and file_exists      ( PAD . "sequence/actions/$item.php" ) ) return TRUE;
    elseif ( $type == 'store'    and isset            ( $GLOBALS ['padSeqStore'] [$item]       ) ) return TRUE;
    elseif ( $type == 'local'    and padIsDataFile    ( $item                                  ) ) return TRUE;
    ...
    elseif ( $type == 'function' and file_exists      ( PAD . "functions/$item.php"        ) ) return TRUE;
