# Regression: the 'exit' error action

## Introduction

Regression test for `$padErrorAction = 'exit'`. The boom page raises an engine-level PHP
...
| `_config/config.php` | Chooses the 'exit' action, `_common` off |
