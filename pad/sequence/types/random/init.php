<?php
  ...
  $pad_seq_random_start = $pad_seq_start;
  $pad_seq_random_end   = $pad_seq_end;
  ...
  if ( $pad_seq_start == 1 and $pad_seq_end == PHP_INT_MAX and ! $pad_seq_rows ) {
    $pad_seq_rows = ($pad_seq_max - $pad_seq_min) + 1;
    $pad_seq_end  = $pad_seq_start + $pad_seq_rows;
  }
