<?php
  ...
  // Precomputed term cache for the pronic sequence.
  //
  // const PADpronic holds its first 99 terms as a 0-indexed array.
  //
  // Loaded by sequence/build/include.php whenever this sequence is built, then read
  // by sequence/plays/play/order.php (term at index, PADpronic[$pqLoop-1]) and by
