# Regression: the 'pad' error action

## Introduction

Regression test for `$padErrorAction = 'pad'`. The boom page raises an engine-level PHP
...
| `_config/config.php` | Chooses the 'pad' action, `_common` off |
