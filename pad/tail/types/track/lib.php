<?php
  ...
  function padTrackFileRequestStart () {
    ...
    global $padTailId, $padTailDir;

    padTailPut ( "track/request/$padTailId-entry.json", padSessionStart () );
  ...
  function padTrackFileRequestEnd () {
    ...
    padTailPut ( "track/request/$padTailId-exit.json", padSessionEnd () );
  ...
  function padTrackFileData ( ) {
    ...
    global $padEtag, $padTailDir, $padOutput;
