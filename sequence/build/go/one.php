<?php
  ...
  if ( $pad_seq_unique and in_array ($pad_seq_one, $pad_seq_base) ) { $pad_seq_sts_11++; return true;  }
  ...
  elseif ( $pad_seq_one === FALSE) { $pad_seq_sts_02++; return false; }
  ...
  if ( $pad_seq_even and  $pad_seq_add % 2 ) $pad_seq_increment++;
  if ( $pad_seq_odd  and !$pad_seq_add % 2 ) $pad_seq_increment++;
