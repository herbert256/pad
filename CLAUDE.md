...
- `SEQUENCES.md` - Sequence subsystem documentation
...
PAD includes a powerful mathematical sequence generation and manipulation engine with 80+ sequence types, transformations, and aggregation operations.

**See [SEQUENCES.md](SEQUENCES.md) for complete documentation.**

Quick example:
```
{fibonacci rows=10}{$fibonacci} {/fibonacci}      # Fibonacci numbers
{sequence '1..10', push='nums'}                   # Store sequence
{resume add=5}                                    # Transform: add 5
{pull:nums}{$sequence} {/pull:nums}               # Iterate
```
