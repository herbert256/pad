<?php
  ...
  // The five info modes by name, and then every option each of them honours - the same
  // set the 'all' selector carries, spelled out so the reference sees each mode chosen.

  $padInfo = 'stats,trace,track,xml,xref';
