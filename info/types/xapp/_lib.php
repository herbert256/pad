<?php
 ...
 #   if ( $dir1 == 'properties')
 #     if ( ! file_exists ( "/pad/seq/types/$dir2" ) )
 #       if ( ! file_exists ( "/pad/options/$dir2.php" ) )
 #         if ( ! str_contains($dir2, '@') )
 #           if ( ! str_contains($dir2, '.') )
 #             touch ( "/pad/options/test/$dir2.php" );

    padInfoXappGo ( '_xref/_raw', $dir1, $dir2, $dir3 );

    global $padPage, $padInfoXappSource, $padStartPage;

    if ( padInsideOther ()                    ) return padInfoXappGo ( '_xref/_skip/1', $dir1, $dir2, $dir3 );
    if ( $padPage <> $padStartPage            ) return padInfoXappGo ( '_xref/_skip/2', $dir1, $dir2, $dir3 );
    if ( str_contains ( $padPage, 'develop' ) ) return padInfoXappGo ( '_xref/_skip/3', $dir1, $dir2, $dir3 );
    if ( str_contains ( $padPage, 'xref'    ) ) return padInfoXappGo ( '_xref/_skip/4', $dir1, $dir2, $dir3 );
    if ( str_contains ( $padPage, 'manual'  ) ) return padInfoXappGo ( '_xref/_skip/5', $dir1, $dir2, $dir3 );
    if ( ! isset ( $_REQUEST['padInclude']  ) ) return padInfoXappGo ( '_xref/_skip/6', $dir1, $dir2, $dir3 );
    ...
    if ( $dir3 and strpos ( $padInfoXappSource, $dir3 ) === FALSE ) 
      return padInfoXappGo ( '_xref/_skip/7', $dir1, $dir2, $dir3 );

    if ( ! $dir3 and strpos ( $padInfoXappSource, $dir2 ) === FALSE ) 
      return padInfoXappGo ( '_xref/_skip/8', $dir1, $dir2, $dir3 );
