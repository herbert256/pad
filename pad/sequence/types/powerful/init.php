<?php
  ...
  // Range setup for powerful, run before generation: the sequence is positive, so a run
  // told to start lower - {powerful from=0}, or a negative from - begins at the first
